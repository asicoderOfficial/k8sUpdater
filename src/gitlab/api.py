...
def get_gitlab_imgs_tags(base_url:str, token:str, project_id:str, container:str) -> dict:
    """ For a specific project, extract all the images of the container registry, and return the tags sorted by the following logic:
    ...
    Args:
        ...
        container (str): Name of the container to extract tags for.

    Returns:
        dict: Sorted tags, in the format {container_name : [latest_tag, previous_to_latest_tag, ...]}
    """    
    ...
    raise ValueError(f'No container named {container} is present at the repository')
